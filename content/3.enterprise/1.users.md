...
If the link has expired, they can select **Enterprise Login** on the [Msty Studio Web](https://msty.studio) landing page and then enter their email address to send a code. 
...
If the user needs to install Msty Studio Desktop, please refer them to [Msty's website](https://msty.ai) where they can download the latest version for their operating system.
