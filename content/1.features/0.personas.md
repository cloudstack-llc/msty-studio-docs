...
You can create new personas from the **Personas** menu item. You don't need to start from scratch though.
...
6. Include **Add Ons** such as any relevant attachments, [real-time data](), related [toolsets](), context shield, desired model and any pertinent model parameters. Add-Ons add a lot of power and flexibility to your Persona and can take it from a simple canned prompt to a full-blown Agent.
7. **Few-Shot Prompts** lets you provide example prompts to guide the Persona's responses, helping it understand the desired style or context of replies based on previous examples.
