...
Use the **New Entry** button to add a new entry. By default, this entry will be a prompt. However, there are additional options to add a Persona, Regenerate, or Continue Generation.
...
And the select the **Turnstile** icon and then select **Add to Queue**, you will see the messages added to the queue and separated by the advanced commands.
