...
Alternative, you can select the **Hide Split Chat** option to hide the split chat without deleting it. This allows you to keep the chat history for future reference.
