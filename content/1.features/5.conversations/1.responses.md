...
Excludes the response from being included in context sent to model during continued conversation. Select **Remove Context Isolation** to include context back in conversation.
