...
Regenerate the message to get a new response from the model. This is useful if you want to see different variations of the same prompt. Or, if you change the model and want to regenerate response using the newly selected model.
