...
navTruncate: false
ogImage: https://docs.msty.studio/images/tools.png
---
...
Try without setting the full path first. If it doesn't work, then set the full path to your dependencies in the Sidecar
connection dialog.
::

::alert{type="info" icon="tabler:info-circle"}
**macOS users**: We recommend opening Sidecar from the terminal `open -a MstySidecar`. This should detect all the dependencies without setting any paths.
::
