...
Please note that not all models support reasoning and that model providers may have different configurations for thinking effort. The "thinking" text may also not be visible for all models as well. 
