...
resources:
  ...
  blogs:
    ...
    - title: "From Chaos to Control: How Msty Studio Enterprise Tames AI Shadow IT"
      description: "Shadow IT in enterprise AI creates context leakage and compliance risk. Msty Studio Enterprise gives teams private AI capabilities with model controls, Knowledge Stacks, Personas, and Agent Mode."
      image: "https://msty.ai/blog/shadow-it/from-chaos-to-control.png"
      url: "https://msty.ai/blog/from-chaos-to-control-how-msty-studio-enterprise-tames-ai-shadow-it"
