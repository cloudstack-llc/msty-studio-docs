...
Context Studio prompts are grouped together in the **Context Studio** category. See [Context Studio](/studios/context-studio) for metadata and Dynamic Mode workflows.
