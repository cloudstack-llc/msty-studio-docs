...
This mode is available for all users. However, Google may limit, throttle, or block requests that are too frequent or too broad. Msty does not have control over these limits.

### Brave

You can use and configure Brave search options.

This mode is available for all users. However, Brave may limit, throttle, or block requests that are too frequent or too broad. Msty does not have control over these limits.
