...
### Select Format
Choose and copy the desired **formatting standard** from the options.

### Paste with Formatting
The copied text is now in your clipboard and can be pasted into text editors while preserving its styling.

### Default Behavior
Msty Studio remembers your last selected format (Markdown, HTML, or Formatted Text) and uses it as the default the next time you click the copy button.
::

### Supported Copy Standards
- Markdown
- HTML
- Formatted Text
