...
Choose how you want to split your content into chunks. Options include:
...
### Overlapping 
Configure how much overlap you want between chunks (only available for Recursive Character).
