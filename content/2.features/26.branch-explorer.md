...
Threads and the mini map now include a branch dropdown for better navigation and comparison. The new Branch Explorer allows you to label branches and perform side-by-side diff comparisons between different conversation branches.
