...
**Knowledge Stacks Next Gen** — a major upgrade to how you build and query your stacks. If you're still using the classic Knowledge Stacks, we highly encourage you to switch to Next Gen for a better experience.
...
- **File (Single Chunk) chunking** — A new chunking method that keeps each item as one whole chunk — perfect for shorter documents or content that shouldn't be split up.
