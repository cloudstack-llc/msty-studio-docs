...
resources:
  videos:
   - "0zoDQr6xiLs"
  blogs:
    - title: "Next Gen Knowledge Stacks: Turning Scattered Work into Living Context"
      description: "Msty Studio Next Gen Knowledge Stacks connect files, conversations, links, and projects so teams can make faster decisions with reliable context."
      image: "https://msty.ai/blog/next-gen-knowledge-stacks/next-gen-knowledge-stacks.png"
      url: "https://msty.ai/blog/next-gen-knowledge-stacks"
