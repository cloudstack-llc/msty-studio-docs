...
Msty uses [gte-tiny](https://huggingface.co/TaylorAI/gte-tiny){target="_blank"} by default, but you can change it to any other embedding model available in your Msty App. You can find an embedding model in **Model Hub > Local Models**.
