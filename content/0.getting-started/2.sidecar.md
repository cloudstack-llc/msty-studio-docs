...
Sidecar unlocks the following features in Studio:
...
Safari web browser unfortunately has constraints which do not allow for direct access to Sidecar.

However, you can still connect Safari to Sidecar using the following methods:

- [Enabling Sidecar's Tunneling Feature](/getting-started/sidecar#connecting-remotely-to-local-ai-including-from-mobile-devices)
