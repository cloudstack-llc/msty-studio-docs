...
Attach files, images, websites, and YouTube links to enhance your conversation. Reusable attachments are managed in [Context Studio](/studios/context-studio). Check out [Attachments](/add-ons/attachments) for chat-level attachment details.
...
See [Conversation Export and Import](/conversations/export-import) for attachment handling, format guidance, and Media Studio session portability.
