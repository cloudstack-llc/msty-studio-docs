...
If you **do not** have an Aurum license and Msty App running on your device, then please head over to [Onboarding](/getting-started/onboarding).
...
## Quick Start Instructions for Msty Studio Web
...
Msty App v1.x users can migrate much of their data to Msty Studio Desktop. Please keep in mind that Studio Desktop is in Alpha right now - **backup** your data prior to migration.
...
Migrated conversations and prompts will be added to new folders in Msty Studio. Your existing Msty Studio Desktop data will not be overwritten.

### Migration steps

You can migrate data one workspace at a time. If you have multiple workspaces, you will need to repeat the migration steps for each workspace you intended to migrate data to.

1. Locate the database and attachment files
...
6. Select the items you want to import from the database file
7. Select the database file you want to import the items from
8. Click the **Migrate** button to migrate items from database file
9. To include attachments, select the zipped attachments file and then click **Import**
