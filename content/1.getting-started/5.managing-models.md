...
If you have an Ollama Turbo account, you can add Turbo as a provider by selecting **Ollama Remote** and then enter your API Key.

Next, set the endpoint URL to `https://ollama.com/`. You can then add a name for the provider and save. 

This will pull the models you have made available to your Ollama Turbo account and you can use these models in your conversations. 
