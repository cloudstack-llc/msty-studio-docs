...
::Collapsible{title="Expand this section to see Msty Studio 2.5.x and 2.6.x downloads"}
  Looking for an earlier Msty Studio release? The versions below are available based on the changelog release history.

  Msty Studio Web is always on the latest version, but you can download a specific version of Msty Studio Desktop here.
